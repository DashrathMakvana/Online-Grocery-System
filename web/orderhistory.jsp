<%-- 
    ...
    Created on : Mar 10, 2021, 3:44:36 PM
    Author     : Admin
--%>
...
<html>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
        <li class="active"><a href="delevryboyHome.jsp">Home</a></li>
    ...
    <table>
        ...
        <tbody>
            <%          
                         ...
                         int z=0;
                        ResultSet rs = st1.executeQuery("select * from cart inner join product where cart.product_id=product.id  and cart.delevryboyname='" + dname + "' and cart.delivered='complete' ");
                while (rs.next()) {
                     z=1;
            %>
            <tr>
