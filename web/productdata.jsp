<%-- 
    ...
    Created on : Mar 19, 2021, 7:49:27 AM
    Author     : Admin
--%>
...
<html>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <form action="searchproductforadmin.jsp" method="post" class="navbar-form navbar-right" role="search">
    ...
    <table>
        ...
        <tbody>
            <%          
                        ...
                        ResultSet rs = st1.executeQuery("select * from product where 1");
                while (rs.next()) {
            %>
            <tr>
                <%sno = sno + 1; %>
