            ...
            <div class="col-md-4 text-center col-sm-6 col-xs-6">
                <div class="thumbnail product-box">
                    ...
                    <div class="caption">
                        ...
                        <p><a href="addtocardAction.jsp?id=<%=rs.getString(1)%>" class="btn btn-success" role="button">Add To Cart</a> <a href="register.jsp" class="btn btn-primary" role="button">Buy</a></p>
                    </div>
                </div>
            </div>
