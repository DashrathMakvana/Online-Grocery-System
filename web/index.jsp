                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">                  
                        ...
                        <li><a href="register.jsp">Signup</a></li>
                         <li><a href="sellerlogin.jsp">Add Product</a></li>
                         <li><a href=" adminlogin.jsp">Addmin</a></li>
                          <li><a href=" delevryboy_login.jsp">Delivery boy Login</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">24x7 Support <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="#"><strong>Call: </strong>+91-456-567-890</a></li>
                                <li><a href="#"><strong>Mail: </strong>grocerry.admin@gmail.com</a></li>
                                <li class="divider"></li>
                    ...
                    <form action="searchproductforindex.jsp" method="post" class="navbar-form navbar-right" role="search">
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="well well-lg offer-box text-center">
                        ...
                        Today's Offer : &nbsp; <span class="glyphicon glyphicon-cog"></span>&nbsp;40 % off  on purchase of <i class="fa fa-inr"></i>2,000 and above till 24 dec !                
                            ...
                            <div class="thumbnail product-box">
                                ...
                                <div class="caption">
                                   ...
                                   <img src="assets/img/<%=rs.getString(7)%>" style="max-height: 220px;max-width: 100%; width: auto;"  class="card-img-top m-2" alt="..">
                                    ...
                                    <p><a href="register.jsp" class="btn btn-success" role="button">Add To Cart</a> <a href="register.jsp" class="btn btn-primary" role="button">Buy Now</a></p>
                                </div>
                            </div>
                        </div>
