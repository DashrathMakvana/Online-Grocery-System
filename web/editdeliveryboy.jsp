<%-- 
    Document   : editdeliveryboy
    Created on : Mar 19, 2021, 8:51:40 AM
    Author     : Admin
--%>
        ...
        <div class="container">
                    ...
                    <div class="card">
                        <div class="card-header text-center c-head text-white">
                            ...
                            <h5>Edit Delivery boy Data Page</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="editdeliveryboyaction.jsp"  method="post">
                                    <%
                ...
                try {
                    ...
                    Statement st1 = conn.createStatement();
                        ...
                        ResultSet rs = st1.executeQuery("select * from delevryboy_data where delevryboyid='" + product_id + "'");
                    while (rs.next()) {
            ...
            %>  
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="email" value="<%=rs.getString(4)%>" id="pwd"  required>
                                </div>

                                <div class="form-group">
                                    <label for="email">Mobile Number:</label>
                                    <input type="text" class="form-control" value="<%=rs.getString(5)%>" id="email" name="number" required>
                                </div>
