<%-- 
    Document   : sellerforgotpassword
    Created on : Feb 27, 2021, 2:53:12 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title> Seller ForgetPassword Page</title>
        ...
        <div class="container">
                    ...
                    <div class="card">
                        <div class="card-header text-center c-head text-white">
                            ...
                            <h5><b>Seller Forgot Password</b></h5>
                        </div>
                         <!-- Error Msg -->     
                       ...
                       <%
                            ...
                            {%>
                                 ...
                                 <%=donermsg%>Login<a href="sellerlogin.jsp">Click here</a>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="sellerforgerpasswordservlert" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control"  id="pwd" name="sellernewpassword" required>
                                </div>
